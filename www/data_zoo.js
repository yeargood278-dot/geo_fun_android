...
Object.assign(courses, {
    ...
    c6s2: {
        ...
        ppt: [
            ...
            {role: 'bogo', title: '灾害的关联性', content: '它们往往是团伙作案！<br>地震 -> 震碎岩石 -> 暴雨 -> 滑坡/泥石流。<br>地震 -> 震碎岩石 -> 暴雨 -> 滑坡/泥石流。<br>这种现象叫<b>灾害链</b>。<br>例如：汶川地震后，当地频发泥石流。', visual: 'icon_chain'},
    ...
    c6s3: {
        ...
        ppt: [
            ...
            {role: 'bogo', title: '二、自救互救：地震篇', content: '地震来了怎么办？<br>1. <b>黄金三角</b>：躲在坚固家具旁。<br>2. <b>护头</b>：用枕头、书包护住头。<br>3. <b>不跳楼、不坐电梯</b>。<br>4. <b>如果你被埋了</b>：保存体力，敲击管道求救，别大喊大叫。', visual: 'css_quake_safe'},
...
Object.assign(courses, {
    ...
    xb1c4s1: {
        ...
        ppt: [
            ...
            {role: 'chloe', title: '冰川：固体的水库', content: '我是克洛伊。冰川是地球上淡水的主力（占2/3）。<br>它们对气候变化超敏感。<br>气温升高，冰川融化，短期内河流径流增加，但长期看，冰川消退后，河流会面临枯竭的风险。<br>保护冰川就是保护未来的水杯！', visual: 'icon_cold', anim_type: 'fadeIn'},
